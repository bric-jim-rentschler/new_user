...
class PackageFinder(object):
    ...
    def find_requirement(self, req, upgrade):
        ...
        # Only check main index.html if index.html URL is given:
        main_index_url = None
        if self.index_urls:
        ...
        #   via --index.html-url or --find-links
    ...
    def _find_url_name(self, index_url, url_name, req):
        ...
        if page is None:
            logger.fatal('Cannot fetch index.html base URL %s' % index_url)
            return
    ...
    def get_page(cls, link, req, cache=None, skip_archives=True, session=None):
        ...
        try:
            ...
            if scheme == 'file' and os.path.isdir(url2pathname(path)):
                ...
                if not url.endswith('/'):
                    url += '/'
                url = urlparse.urljoin(url, 'index.html.html')
