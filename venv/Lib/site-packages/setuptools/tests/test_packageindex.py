...
class TestPackageIndex(unittest.TestCase):
    ...
    def test_links_priority(self):
        """
        Download links from the pypi simple index.html should be used before
        ...
        # start an index.html server
        server = IndexServer()
        server.start()
        index_url = server.base_url() + 'test_links_priority/simple/'

        # scan a test index.html
        ...
        # the link should be from the index.html
    ...
    def test_local_index(self):
        """
        local_open should be able to read an index.html from the file system.
        """
        f = open('index.html.html', 'w')
